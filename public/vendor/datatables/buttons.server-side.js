(function ($, DataTable) {
    ...
    var _buildParams = function (dt, action, onlyVisibles) {
        ...
        if (onlyVisibles) {
            params.visible_columns = _getVisibleColumns();s
        } else {
    ...
    $('.buttons-create').html('<i class="cil-plus"></i> Create');
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: function (dt) {
            return '<i class="cil-spreadsheet"></i> ' + dt.i18n('buttons.excel', 'Excel');
        },
    ...
    DataTable.ext.buttons.postExcelVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="cil-spreadsheet"></i> ' + dt.i18n('buttons.excel', 'Excel (only visible columns)');
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: function (dt) {
            return '<i class="cil-data-transfer-down"></i> ' + dt.i18n('buttons.export', 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: function (dt) {
            return '<i class="cil-file"></i> ' + dt.i18n('buttons.csv', 'CSV');
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: function (dt) {
            return  '<i class="cil-print"></i> ' + dt.i18n('buttons.print', 'Print');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function (dt) {
            return '<i class="cil-action-undo"></i> ' + dt.i18n('buttons.reset', 'Reset');
        },
    ...
    DataTable.ext.buttons.create = {
        ...
        text: function (dt) {
            return '<i class="cil-plus"></i> ' + dt.i18n('buttons.create', 'Create');
        },
